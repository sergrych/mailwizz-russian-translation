 ...
 */
 ...
 return array (
  ...
  'Mobile' => 'Mobile',
  'Tablet' => 'Планшет',
  'Activity map (click to view)' => 'Карта действий (нажмите для просмотра)',
  'Enter full screen' => 'Enter full screen',
  'Exit full screen' => 'Exit full screen',
  'Opens' => 'Открыто',
  'Clicks' => 'Клики',
  'Unsubscribes' => 'Отказы от Рассылки',
  'Email' => 'Email',
  'Date' => 'Дата',
  'Ip address' => 'Ip адрес',
  'Device' => 'Устройство',
  ...
  'Back to campaign overview' => 'Назад к Обзору кампании',
  'Unique opens' => 'Уникальных открытых',
  ...
  'Bounce report' => 'Bounce рапорт',
  'Opens report' => 'Открытие рапорт',
