 ...
 */
 ...
 return array (
  ...
  'Unconfirm' => 'Unconfirm',
  'Delete' => 'Delete',
  'These conditions will be applied to the email body and if matched, the given action will be taken against the email address.<br />Conditions are applied in the order they are added and execution stops at first match.' => 'These conditions will be applied to the email body and if matched, the given action will be taken against the email address.<br />Conditions are applied in the order they are added and execution stops at first match.',
